...
// The original 2005 release used Boost only for fixed-width integers and
// static assertions. C++11 provides both directly, avoiding a host-only Boost
// dependency (and allowing the MinGW cross build to use the same source).
#include <cstdint>
#define BOOST boost
namespace boost {
